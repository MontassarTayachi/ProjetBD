...
var InteractionContext = React16.createContext({
  item: null,
  axis: {
    x: null,
    y: null
...
function InteractionProvider(props) {
  ...
  const [data, dispatch] = React16.useReducer(dataReducer, {
    item: null,
    axis: {
      x: null,
      y: null
  ...
  const value = React16.useMemo(() => _extends({}, data, {
    dispatch
  }), [data]);
...
function HighlightedProvider({
  ...
  return (0, import_jsx_runtime8.jsx)(HighlightedContext.Provider, {
    value: providerValue,
    children
  });
}
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime9.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index) => {
      ...
      return (0, import_jsx_runtime9.jsxs)(React29.Fragment, {
...
function useChartGradient() {
  ...
  return React31.useCallback((axisId, direction) => `${chartId}-gradient-${direction}-${axisId}`, [chartId]);
}
...
function useItemTooltip() {
  ...
  if (itemSeries.type === "pie") {
    const point2 = itemSeries.data[item.dataIndex];
    const label2 = getLabel(point2.label, "tooltip");
    const value2 = _extends({}, point2, {
      label: label2
    });
...
//# sourceMappingURL=chunk-EAZKLXN5.js.map
