...
import {
  ...
  useYScale,
  useZColorScale
} from "./chunk-EAZKLXN5.js";
import {
  arc_default,
  color
} from "./chunk-YTAFJYAW.js";
import {
  warnOnce
} from "./chunk-TTAICKHP.js";
import "./chunk-X67YJQXJ.js";
import "./chunk-TBUVEUUB.js";
import {
  useThemeProps
} from "./chunk-6TISD26S.js";
import "./chunk-NCQRDMLI.js";
import "./chunk-ZCSSBJ3Q.js";
import "./chunk-L3EXRUZB.js";
import "./chunk-OX2WJDOJ.js";
import {
  _objectWithoutPropertiesLoose
} from "./chunk-BFL632LT.js";
import "./chunk-DLLZ6XSG.js";
import "./chunk-AB3XZ4YW.js";
import "./chunk-U6VPIHVS.js";
import "./chunk-SMVKUIN2.js";
import {
  composeClasses,
...
function Scatter(props) {
  ...
  return (0, import_jsx_runtime12.jsx)("g", {
    children: cleanData.map((dataPoint) => (0, import_jsx_runtime12.jsx)("circle", _extends({
      cx: 0,
      cy: 0,
...
true ? Scatter.propTypes = {
  ...
  colorGetter: import_prop_types8.default.func,
  markerSize: import_prop_types8.default.number.isRequired,
  /**
   * Callback fired when clicking on a scatter item.
  ...
  xScale: import_prop_types8.default.func.isRequired,
  yScale: import_prop_types8.default.func.isRequired
} : void 0;
...
function ScatterPlot(props) {
  ...
  return (0, import_jsx_runtime13.jsx)(React13.Fragment, {
    children: seriesOrder.map((seriesId) => {
      ...
      const xScale = xAxis[xAxisId ?? xAxisKey ?? defaultXAxisId].scale;
      const yScale = yAxis[yAxisId ?? yAxisKey ?? defaultYAxisId].scale;
      return (0, import_jsx_runtime13.jsx)(ScatterItems, _extends({
        xScale,
        yScale,
        color: color2,
        colorGetter,
...
var _excluded8 = ["xAxis", "yAxis", "zAxis", "series", "tooltip", "axisHighlight", "voronoiMaxRadius", "disableVoronoi", "legend", "width", "height", "margin", "colors", "sx", "grid", "topAxis", "leftAxis", "rightAxis", "bottomAxis", "onItemClick", "children", "slots", "slotProps", "loading", "highlightedItem", "onHighlightChange", "className"];
...
var ScatterChart = React14.forwardRef(function ScatterChart2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
  ...
  return (0, import_jsx_runtime14.jsx)(ResponsiveChartContainer, _extends({
    ref
  }, chartContainerProps, {
    children: (0, import_jsx_runtime14.jsxs)(ZAxisContextProvider, _extends({}, zAxisProps, {
      children: [!props.disableVoronoi && (0, import_jsx_runtime14.jsx)(ChartsVoronoiHandler, _extends({}, voronoiHandlerProps)), (0, import_jsx_runtime14.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), (0, import_jsx_runtime14.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime14.jsx)("g", {
        "data-drawing-container": true,
        children: (0, import_jsx_runtime14.jsx)(ScatterPlot, _extends({}, scatterPlotProps))
      }), (0, import_jsx_runtime14.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime14.jsx)(ChartsLegend, _extends({}, legendProps)), (0, import_jsx_runtime14.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps)), !props.loading && (0, import_jsx_runtime14.jsx)(ChartsTooltip, _extends({}, tooltipProps)), children]
    }))
  }));
});
true ? ScatterChart.propTypes = {
   ...
   * @default false
   */
  disableVoronoi: import_prop_types10.default.bool,
  /**
   * Option to display a cartesian grid in the background.
   */
   ...
   * If `undefined`, the radius is assumed to be infinite.
   */
  voronoiMaxRadius: import_prop_types10.default.number,
  /**
   * The width of the chart in px. If not defined, it takes the width of the parent element.
   */
  width: import_prop_types10.default.number,
...
var _excluded9 = ["xAxis", "yAxis", "width", "height", "margin", "colors", "sx", "showTooltip", "tooltip", "showHighlight", "axisHighlight", "children", "slots", "slotProps", "data", "plotType", "valueFormatter", "area", "curve", "className"];
...
var SparkLineChart = React15.forwardRef(function SparkLineChart2(props, ref) {
  ...
  return (0, import_jsx_runtime15.jsxs)(ResponsiveChartContainer, _extends({}, other, {
    ref,
    series: [_extends({
      type: plotType,
      data,
    ...
    children: [plotType === "bar" && (0, import_jsx_runtime15.jsx)(BarPlot, {
      skipAnimation: true,
      slots,
      slotProps
    }), plotType === "line" && (0, import_jsx_runtime15.jsxs)(React15.Fragment, {
    ...
    }), (0, import_jsx_runtime15.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), showTooltip && (0, import_jsx_runtime15.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slotProps,
      slots
    })), children]
  }));
...
true ? SparkLineChart.propTypes = {
   ...
   * @default 'line'
   */
  plotType: import_prop_types11.default.oneOf(["bar", "line"]),
  /**
   * The chart will try to wait for the parent container to resolve its size
   * before it renders for the first time.
   *
   ...
   * @default false
   */
  showHighlight: import_prop_types11.default.bool,
  /**
   * Set to `true` to enable the tooltip in the sparkline.
   * @default false
   */
  showTooltip: import_prop_types11.default.bool,
  /**
   * If `true`, animations are skipped.
   * If unset or `false`, the animations respects the user's `prefers-reduced-motion` setting.
   */
   ...
   */
  xAxis: import_prop_types11.default.shape({
    classes: import_prop_types11.default.object,
   ...
   * Notice it is a single [[AxisConfig]] object, not an array of configuration.
   */
  yAxis: import_prop_types11.default.shape({
    classes: import_prop_types11.default.object,
    colorMap: import_prop_types11.default.oneOfType([import_prop_types11.default.shape({
      colors: import_prop_types11.default.arrayOf(import_prop_types11.default.string).isRequired,
      type: import_prop_types11.default.oneOf(["ordinal"]).isRequired,
...
function GaugeProvider(props) {
  ...
  return (0, import_jsx_runtime16.jsx)(GaugeContext.Provider, {
    value: contextValue,
    children
  });
}
...
var _excluded10 = ["width", "height", "margin", "title", "desc", "value", "valueMin", "valueMax", "startAngle", "endAngle", "outerRadius", "innerRadius", "cornerRadius", "cx", "cy", "children"];
...
var GaugeContainer = React17.forwardRef(function GaugeContainer2(props, ref) {
  ...
  return (0, import_jsx_runtime17.jsx)(ResizableContainer, _extends({
    ref: containerRef,
    ownerState: {
      width: inWidth,
      height: inHeight
    ...
    children: width && height ? (0, import_jsx_runtime17.jsx)(DrawingProvider, {
      width,
      height,
      margin: _extends({
        left: 10,
      ...
      svgRef,
      children: (0, import_jsx_runtime17.jsx)(GaugeProvider, {
        value,
        valueMin,
        valueMax,
        startAngle,
        ...
        cx,
        cy,
        children: (0, import_jsx_runtime17.jsx)(ChartsSurface, {
          width,
          height,
          ref: chartSurfaceRef,
          title,
...
function GaugeValueArc(props) {
  ...
  return (0, import_jsx_runtime18.jsx)(StyledPath, _extends({
...
function GaugeReferenceArc(props) {
  ...
  return (0, import_jsx_runtime19.jsx)(StyledPath2, _extends({
    transform: `translate(${cx}, ${cy})`,
    d: arc_default().cornerRadius(cornerRadius)({
      startAngle,
      endAngle,
...
var _excluded11 = ["text", "className"];
...
function GaugeValueText(props) {
  ...
  return (0, import_jsx_runtime20.jsx)("g", {
    className,
    children: (0, import_jsx_runtime20.jsx)(ChartsText, _extends({
      x: cx,
      y: cy,
      text: formattedText,
      style: {
...
true ? GaugeValueText.propTypes = {
  ...
  text: import_prop_types13.default.oneOfType([import_prop_types13.default.func, import_prop_types13.default.string])
} : void 0;

// node_modules/@mui/x-charts/Gauge/Gauge.js
var import_jsx_runtime21 = __toESM(require_jsx_runtime());
var _excluded12 = ["text", "children", "classes", "className"];
...
var Gauge = React21.forwardRef(function Gauge2(props, ref) {
  ...
  return (0, import_jsx_runtime21.jsxs)(GaugeContainer, _extends({}, other, {
    className: clsx_default(classes.root, className),
    ref,
    children: [(0, import_jsx_runtime21.jsx)(GaugeReferenceArc, {
      className: classes.referenceArc
    }), (0, import_jsx_runtime21.jsx)(GaugeValueArc, {
      className: classes.valueArc
    }), (0, import_jsx_runtime21.jsx)(GaugeValueText, {
...
true ? Gauge.propTypes = {
   ...
   * @default 0
   */
  cornerRadius: import_prop_types14.default.oneOfType([import_prop_types14.default.number, import_prop_types14.default.string]),
  /**
   * The x coordinate of the arc center.
   * Can be a number (in px) or a string with a percentage such as '50%'.
   * The '100%' is the width the drawing area.
   */
  cx: import_prop_types14.default.oneOfType([import_prop_types14.default.number, import_prop_types14.default.string]),
  /**
   * The y coordinate of the arc center.
   * Can be a number (in px) or a string with a percentage such as '50%'.
   * The '100%' is the height the drawing area.
   */
  cy: import_prop_types14.default.oneOfType([import_prop_types14.default.number, import_prop_types14.default.string]),
   ...
   * @default 360
   */
  endAngle: import_prop_types14.default.number,
  /**
   * The height of the chart in px. If not defined, it takes the height of the parent element.
   */
   ...
   * @default '80%'
   */
  innerRadius: import_prop_types14.default.oneOfType([import_prop_types14.default.number, import_prop_types14.default.string]),
  /**
   * The margin between the SVG and the drawing area.
   * It's used for leaving some space for extra information such as the x- and y-axis or legend.
   * Accepts an object with the optional properties: `top`, `bottom`, `left`, and `right`.
   ...
   * @default '100%'
   */
  outerRadius: import_prop_types14.default.oneOfType([import_prop_types14.default.number, import_prop_types14.default.string]),
  /**
   * The start angle (deg).
   * @default 0
   */
  startAngle: import_prop_types14.default.number,
   ...
   * @default 100
   */
  valueMax: import_prop_types14.default.number,
  /**
   * The minimal value of the gauge.
   * @default 0
   */
  valueMin: import_prop_types14.default.number,
