...
var HighlightedContext = React15.createContext({
  isInitialized: false,
  data: {
...
function useHighlighted() {
  const {
    isInitialized,
    data
  } = React17.useContext(HighlightedContext);
  if (!isInitialized) {
...
var ZAxisContext = React18.createContext({
  zAxis: {},
  zAxisIds: []
});
if (true) {
...
function ZAxisContextProvider(props) {
  ...
  const zAxis = React18.useMemo(() => inZAxis == null ? void 0 : inZAxis.map((axisConfig) => {
...
var useAxisEvents = (disableAxisListener) => {
  ...
  const mousePosition = React27.useRef({
    isInChart: false,
    x: -1,
    y: -1
  });
...
var ChartsSurface = React28.forwardRef(function ChartsSurface2(inProps, ref) {
...
//# sourceMappingURL=chunk-JXE2MXHW.js.map
