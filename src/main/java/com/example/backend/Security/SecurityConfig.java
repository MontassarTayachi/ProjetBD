...
public class SecurityConfig  {
    ...
    protected SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers("/api/profil/**").hasRole("ADMIN")
                .requestMatchers("/api/employeur/**").hasRole("ADMIN")
                .requestMatchers("/api/structure/**").hasRole("ADMIN")
                .requestMatchers("/api/formateur/**").hasAnyRole("ADMIN","USER")
                .requestMatchers("/api/formation/**").hasAnyRole("ADMIN","USER")
                .requestMatchers("/api/participant/**").hasAnyRole("ADMIN","USER")
                .anyRequest()
                .authenticated()
                .and()
                .sessionManagement()
